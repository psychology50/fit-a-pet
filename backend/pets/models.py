...
class CycleDetail(models.Model):
    ...
    cycle_id = models.ForeignKey(Cycle, on_delete=models.CASCADE, db_column='cycle_id', related_name='detail')
...
class AchieveCycle(models.Model):
    ...
    detail_id = models.ForeignKey(CycleDetail, on_delete=models.CASCADE, db_column='detail_id', related_name='achievement')
